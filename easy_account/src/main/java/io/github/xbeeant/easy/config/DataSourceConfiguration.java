 ...
 */
@Configuration
@MapperScan(annotationClass = Mapper.class, basePackages = {"io.github.xbeeant.easy.core.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        return SqlSessionFactoryUtil.getSqlSessionFactory(dataSource
                , "classpath:/mybatis/mariadb/easy_core/**/**.xml"
                , "io.github.xbeeant.easy.core.model"
